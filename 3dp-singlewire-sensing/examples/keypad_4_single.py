...
if __name__ == "__main__":
    ...
    # surface = surface.rotate_x(10, inplace=False)
    # surface = surface.rotate_y(10, inplace=False)
    # surface.save(f"../models/{mesh_file_name}_tilted.stl")
    ...
    # # optimized resitances: [592398.182227398, 612323.4282890208, 624328.757325643]
    # # so then use below code to know optimize resistance: wire: 2.3 M, trace_r: 180.0 k => i.e., 600k in code
    # # (0.3 is adjustment of esimated to real-world resistance)
    # n_nodes = len(nodes)
    # voltage_thres = 2.5
    # wire_r, trace_r, score = optimize_resistances(
    #     n_nodes=n_nodes-1,
    #     wire_resistance_candidates=np.arange(0.1e6, 10e6, 200e3),
    #     trace_resistance_candidates=np.arange(100e3, 569e3, 50e3) * 0.3,
    # )
    # print(
    #     f"wire: {wire_r, precision=1}, trace_r: {trace_r}"
    # )
    # voltage_thres = 2.5
    # wire_r, trace_r, score = optimize_resistances(
    #     n_nodes=4,
    #     wire_resistance_candidates=np.arange(0.1e6, 10e6, 200e3),
    #     trace_resistance_candidates=[400e3],
    # )
    # print(
